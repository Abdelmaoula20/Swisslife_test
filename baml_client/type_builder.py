...
class TypeBuilder(type_builder.TypeBuilder):
    def __init__(self):
        super().__init__(classes=set(
          ["ClassificationResponse","ContactInfo","FormCompletionResponse","PersonalInfo","Theme",]
        ), enums=set(
          []
    ...
    @property
    def FormCompletionResponse(self) -> "FormCompletionResponseViewer":
        return FormCompletionResponseViewer(self)
...
class FormCompletionResponseAst:
    def __init__(self, tb: type_builder.TypeBuilder):
        _tb = tb._tb # type: ignore (we know how to use this private attribute)
        self._bldr = _tb.class_("FormCompletionResponse")
        self._properties: typing.Set[str] = set([  "personal_info",  "contact_info",  ])
        self._props = FormCompletionResponseProperties(self._bldr, self._properties)

    def type(self) -> baml_py.FieldType:
        return self._bldr.field()

    @property
    def props(self) -> "FormCompletionResponseProperties":
        return self._props


class FormCompletionResponseViewer(FormCompletionResponseAst):
    def __init__(self, tb: type_builder.TypeBuilder):
        super().__init__(tb)
...
class FormCompletionResponseProperties:
    def __init__(self, bldr: baml_py.ClassBuilder, properties: typing.Set[str]):
        self.__bldr = bldr
        self.__properties = properties # type: ignore (we know how to use this private attribute) # noqa: F821
